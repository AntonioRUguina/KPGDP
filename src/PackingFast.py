...
class Solution_Gurobi:
    ...
    def run_algorithm(self):
        ...
        of = self.construct_solution_kgpdp_packing(k=self.groups, p=self.p, time_max=self.max_time, uniqueList = uniqueList, grasp_bound=self.grasp_bound)
        return of
    ...
    def construct_solution_kgpdp_packing(self, k, p, time_max, uniqueList, grasp_bound):
